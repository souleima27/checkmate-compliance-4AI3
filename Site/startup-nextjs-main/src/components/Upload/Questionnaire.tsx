            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-6 transition-all duration-300 hover:shadow-2xl">
                ...
                <div className="mb-6">
                    ...
                    <input
                        ...
                        onChange={(e) => updateField("Société de Gestion", e.target.value)}
                ...
                <div className="space-y-1">
                    ...
                    <QuestionItem
                        ...
                        value={metadata["Le document fait-il référence à une nouvelle Stratégie"] || false}
                        onChange={(v) => updateField("Le document fait-il référence à une nouvelle Stratégie", v)}
                    />
                    <QuestionItem
