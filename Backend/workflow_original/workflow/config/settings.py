...
REGLES_CONTEXTUELLES_PATH = r"workflow\caches\regles_contextuelles.json"
REGLES_STRUCTURELLES_PATH = r"workflow\caches\regles_structurelles.json"

# Fichiers Excel de référence
GLOSSAIRE_DISCLAIMERS_PATH = r"dataset\GLOSSAIRE DISCLAIMERS 20231122 .xlsx"
REGISTRATION_ABROAD_PATH = r"dataset\Registration abroad of Funds_20251008.xlsx"

# Glossaires JSON (si déjà converti)
GLOSSAIRES_JSON_PATH = r"workflow\caches\glossaires.json"

# Documents de test
#TEST_DOCUMENT_PATH = r"dataset\example_2"
TEST_DOCUMENT_PATH = r"Batch 2"

# Dossiers de sortie
OUTPUT_DIR = r"workflow\output"
LOGS_DIR = r"workflow\logs"
CACHE_DIR = r"workflow\caches"
